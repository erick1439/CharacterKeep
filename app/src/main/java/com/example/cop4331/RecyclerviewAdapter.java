...
public class RecyclerviewAdapter extends RecyclerView.Adapter<RecyclerviewAdapter.ViewHolder>
{
    ...
    private ArrayList<String> linkingId = new ArrayList<>();
    private Context mContext;
    private ArrayList<ImageView> avatars = new ArrayList<>();


    // Constructor that initializes the array lists for the adapter.
    public RecyclerviewAdapter(Context context, ArrayList<Integer> imageArray, ArrayList<String> names, ArrayList<String> classes, ArrayList<String> races, ArrayList<String> cHp, ArrayList<String> mHp, ArrayList<String> linkingId) {
        this.names = names;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        // Deletes all the inforamtion related to this character.
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                String id = linkingId.get(position);
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                startIntent.putExtra("linkingId", linkingId.get(position));
    ...
    // Deletes all the information associated with this card in the database.
    public void deleteCard(final String name, final String id)
    {
